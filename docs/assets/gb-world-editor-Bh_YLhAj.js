const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./gb-world-editor-D5h-ZxCG.js","./common-C8PHBgJ_.js"])))=>i.map(i=>d[i]);
import{m as t,L as n,_ as a}from"./theme-DaBNiN0a.js";t(n,{target:document.body,props:{beforeMenu:`<span class="brand">GB&nbsp;World&nbsp;Editor <span class="sub">v1</span></span>
  ...
  <main id="panel"></main>`,currentPage:"gb-world-editor.html",initialize:()=>a(()=>import("./gb-world-editor-D5h-ZxCG.js"),__vite__mapDeps([0,1]),import.meta.url)}});
