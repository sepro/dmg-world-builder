...
import{m as a,L as e,_ as n}from"./theme-CNUsdib9.js";a(e,{target:document.body,props:{beforeMenu:`<span class="brand">GB&nbsp;Tile&nbsp;Reducer <span class="sub">v1</span></span>
    ...
    <input type="file" id="file-input" accept="image/png,image/*" style="display:none;">`,content:'<main id="panel"></main>',currentPage:"gb-tile-reducer.html",initialize:()=>n(()=>import("./gb-tile-reducer-wE8D0yFZ.js"),__vite__mapDeps([0,1]),import.meta.url)}});
