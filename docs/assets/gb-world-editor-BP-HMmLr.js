const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./gb-world-editor-CiultSOQ.js","./common-68Tf6uEl.js"])))=>i.map(i=>d[i]);
import{m as t,L as n,_ as a}from"./theme-CNUsdib9.js";t(n,{target:document.body,props:{beforeMenu:`<span class="brand">GB&nbsp;World&nbsp;Editor <span class="sub">v1</span></span>
  ...
  <main id="panel"></main>`,currentPage:"gb-world-editor.html",initialize:()=>a(()=>import("./gb-world-editor-CiultSOQ.js"),__vite__mapDeps([0,1]),import.meta.url)}});
