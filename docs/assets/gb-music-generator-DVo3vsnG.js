const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./gb-music-generator-VTSBzZtP.js","./common-C8PHBgJ_.js"])))=>i.map(i=>d[i]);
import{m as t,L as n,_ as e}from"./theme-DaBNiN0a.js";t(n,{target:document.body,props:{beforeMenu:`<span class="brand">GB&nbsp;Music&nbsp;Generator <span class="sub">v1</span></span>
  ...
  </main>`,currentPage:"gb-music-generator.html",initialize:()=>e(()=>import("./gb-music-generator-VTSBzZtP.js"),__vite__mapDeps([0,1]),import.meta.url)}});
