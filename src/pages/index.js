  ...
  props: {
    ...
    content: `<div class="hero"><h1>Game Boy Tool Suite</h1><p>Build worlds, boss arenas, sprites and chiptunes for GBDK-2020 — right in the browser.</p></div>
      <main class="tools">
        ...
        <a class="tool-card" href="gb-sprite-editor.html"><canvas id="preview-sprite" width="160" height="48"></canvas><h2>Sprite Editor</h2><p>Draw sprite sheets, arrange metasprites, and sequence animations. Exports .gbsprite.json and PNG.</p><span class="go">Open editor &raquo;</span></a>
        <a class="tool-card" href="gb-music-generator.html"><canvas id="preview-music" width="160" height="48"></canvas><h2>Music Generator</h2><p>A deterministic four-channel chiptune improviser with JSON and MIDI export.</p><span class="go">Open generator &raquo;</span></a>
        ...
        <a class="tool-card" href="gb-sfx-sequencer.html"><canvas id="preview-sfxseq" width="160" height="48"></canvas><h2>SFX Sequencer</h2><p>Author multi-note chimes — victory, fail, UI — from procedural archetypes, on a piano roll.</p><span class="go">Open sequencer &raquo;</span></a>
